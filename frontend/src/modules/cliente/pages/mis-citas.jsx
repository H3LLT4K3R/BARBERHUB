...
import { horaDeCita, comoFechaLocal } from "../../../utils/fechaCita.js";
        ...
        {citas.length === 0 ? (
          ...
          <div className="lista-citas">
            {citas.map((cita) => {
              ...
              const horario = formatearHorarioCorto(comoFechaLocal(cita.scheduled_at), horaDeCita(cita.scheduled_at));
