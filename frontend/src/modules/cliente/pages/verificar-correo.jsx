  ...
  return (
    <div className="vc-pagina">
      ...
      <div className="vc-contenido">
        <div className="vc-tarjeta">

          <div className="vc-icono" aria-hidden>
            <IconMail size={32} stroke={1.5} color="#111" />
          </div>

          <h1 className="vc-titulo">Verifica tu correo</h1>

          <p className="vc-texto">
            Enviamos un código de 6 dígitos a
          </p>
          <p className="vc-email">{email}</p>
          <p className="vc-texto vc-texto--sub">
            Ingresa el código para continuar
          </p>

          <form className="vc-formulario" onSubmit={verificar}>
            <div className="vc-fila-codigo" onPaste={onPaste}>
              {digitos.map((d, i) => (
                <input
                  key={i}
                  ref={(el) => {
          ...
          <p className="vc-reenvio">
            ¿No recibiste el código?{" "}
            <button
              type="button"
              className="vc-enlace-dorado"
